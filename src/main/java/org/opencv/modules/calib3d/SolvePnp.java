...
import static org.opencv.modules.calib3d.Calib3d.*;

// Code based on: https://github.com/opencv/opencv/blob/master/modules/calib3d/src/solvepnp.cpp
public class SolvePnp {

    boolean solvePnP(InputArray _opoints, InputArray _ipoints,
                     InputArray _cameraMatrix, InputArray _distCoeffs,
                     OutputArray _rvec, OutputArray _tvec, boolean useExtrinsicGuess, int flags )
    {
        ...
        if (flags == SOLVEPNP_EPNP || flags == SOLVEPNP_DLS || flags == SOLVEPNP_UPNP)
        {
            ...
            Calib3d.undistortPoints(ipoints, undistortedPoints, cameraMatrix, distCoeffs);
    ...
    /*else if (flags == SOLVEPNP_DLS)
    {
        ...
        boolean result = PnP.compute_pose(R, tvec);
        if (result)
            Rodrigues(R, rvec);
        return result;
    }
    ...
    class PnPRansacCallback CV_FINAL : public PointSetRegistrator::Callback
    {
        ...
        boolean _useExtrinsicGuess=false, Mat _rvec=Mat(), Mat _tvec=Mat() )
        ...
        int runKernel( InputArray _m1, InputArray _m2, OutputArray _model ) const CV_OVERRIDE
        {
            ...
            boolean correspondence = solvePnP( _m1, _m2, cameraMatrix, distCoeffs,
    ...
    boolean solvePnPRansac(InputArray _opoints, InputArray _ipoints,
                        InputArray _cameraMatrix, InputArray _distCoeffs,
                        OutputArray _rvec, OutputArray _tvec, boolean useExtrinsicGuess,
                        ...
                        OutputArray _inliers, int flags)
    {
        ...
        {
            boolean result = solvePnP(opoints, ipoints, cameraMatrix, distCoeffs, _rvec, _tvec, useExtrinsicGuess, ransac_kernel_method);
