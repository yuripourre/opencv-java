...
public class EPNP {
    ...
    private int number_of_correspondences;
    private int max_nr;
    ...
    public EPNP(Mat cameraMatrix, Mat opoints, Mat ipoints) {
        ...
        number_of_correspondences = (int) Math.max(opoints.checkVector(3, CV_32F), opoints.checkVector(3, CV_64F));

        pws = new double[3 * number_of_correspondences];
        us = new double[2 * number_of_correspondences];
        ...
        alphas = new double[4 * number_of_correspondences];
        pcs = new double[3 * number_of_correspondences];
        ...
        {
        double[] cc = new double[3 * 3], cc_inv = new double[3 * 3];
